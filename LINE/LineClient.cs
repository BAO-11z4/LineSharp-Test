...
namespace LineSharp
{
    internal class LineClient
    {
        ...
        public void VerifyPin()
        {
            ...
            if (pin_verified.Result != null && !String.IsNullOrEmpty(pin_verified.Result.Verifier) && 
                // !String.IsNullOrEmpty(pin_verified.ErrorCode) && // remove this coz ping result doesn't contains ErrorCode
                (!String.IsNullOrEmpty(pin_verified.Result.AuthPhase) && pin_verified.Result.AuthPhase.Equals("QRCODE_VERIFIED"))
                )
            {
        ...
        public void Update()
        {
            ...
            switch (operation.Type)
            {
                ...
                case OpType.NOTIFIED_RECEIVED_CALL:
                    if (OnNotifiedReceivedCall != null) OnNotifiedReceivedCall.Invoke(this, new NotifiedReceivedCallEventArgs(operation));
                    break;
